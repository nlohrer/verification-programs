/***
 ***  generated by CSeq [ 0000 / 0000 ] 2024-06-29 14:06:25
 ***
 ...
 ***
 ***  params:
 ***    -i examples/long_threads.c --backend CPAchecker --rounds 2
 ***
 ***  modules:
...
extern void __VERIFIER_ERROR();//#include <stdio.h>
//#include <stdlib.h>
#define THREADS 2
#define ROUNDS 2
...
#define NULL 0
                         ...
                         unsigned int __cs_thread_lines[] = {4, 6, 7};
...
tthr2_0_6: IF(2,6,tthr2_0_7)
                                   ...
                                   __cs_local_thr2___cs_tmp_if_cond_0 = (x < 12);
